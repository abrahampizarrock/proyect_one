...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference("Producto.count") do
      post productos_url, params: { producto: { description: @producto.description, image: @producto.image, title: @producto.title, user_id: @producto.user_id } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { description: @producto.description, image: @producto.image, title: @producto.title, user_id: @producto.user_id } }
